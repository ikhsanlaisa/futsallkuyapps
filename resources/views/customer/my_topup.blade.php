		...
		<div class="row">
			<div class="col-md-3">
				...
				<div style="margin:0 5px 20px;">
					<div class="bottom d-flex align-items-center justify-content-between align-self-end">
						<div class="profile-info d-flex">
							<div class="title">
								<h5 style="text-transform: uppercase;">{{$user->name}}</h5>
								<!-- <p>{{$user->id}}</p> -->
								<p>Rp{{$user->saldo}}</p>
							</div>
				...
				<ul class="nav nav-pills flex-column text-sm">
					<li class="nav-item"><a href="/my-booking" class="nav-link">My Booking</a></li>
					<li class="nav-item"><a href="/topup" class="nav-link">Top Up</a></li>
					...
					<div id="nav-tabContent" class="tab-content" style="">
						<div id="tab1" role="tabpanel" aria-labelledby="tab4-4-tab" class="tab-pane fade active show">
							<div id="accordion" role="tablist" class="mb-5">
								...
								@foreach($booking as $r => $item)
								<!-- ROW ITEM -->
								<div class="card">
									<div role="tab" class="card-header">
										<a data-toggle="collapse" href="#row-1-{{$r}}" class="collapsed" style="display: block;">
											<span><i class="fa fa-reorder"></i>  {{$item->lapangan->name}} &mdash; {{$item->created_at}}</span>
										...
										<div class="card-body">
											<div class="row row-item-detail">
												...
												<div class="col-md-7 detail-place">
													...
													<div class="row">
														...
														<div class="col-md-5" style="text-align: left;">
															<h6><i class="fa fa-user-circle"></i> {{$user->name}}</h6>
												...
												<div class="col-md-3 detail-ad">
													...
													<h6>Tarif Bayar</h6>
													<p>{{$item->tarif}}/Jam</p>
													<p><a href="/booked/{{$item->id}}">Show Detail</a></p>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="card">
									<div role="tab" class="card-header">
										<a data-toggle="collapse" href="#row-2-{{$r}}" class="collapsed" style="display: block;">
											<span><i class="fa fa-reorder"></i>  {{$item->lapangan->name}} &mdash; {{$item->created_at}}</span>
											<span class="float-lg-right"><a href=""><i class="fa fa-bookmark"></i> <i>{{$item->id}}</i></a></span>
										</a>
									</div>
