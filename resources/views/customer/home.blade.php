...
@section('content')
<section style="background: url({{asset('images/customer/sample/coverblock.jpg')}}) center top no-repeat; background-size: cover;" class="bar no-mb color-white text-center bg-fixed relative-positioned">
  ...
  <div class="row">
    ...
    <div class="col-lg-3">
      ...
      <div class="home-blog-post">
        <div class="image" style="min-height: 150px; height: 10px"><img src="{{asset('images/lapangan/')}}/{{$l->foto}}" alt="..." class="img-fluid">
        ...
        <div class="text">
	     	...
	     	<div>{{$l->price}},-/jam</div>
	      	...
	      	<a href="#" class="btn btn-template-outlined btn-block">Book now</a>
        </div>
      </div>
      </div>
    </div>
